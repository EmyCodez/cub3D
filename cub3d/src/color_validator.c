...
/*   Updated: 2024/10/29 14:35:53 by adshafee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	assign_the_ceiling_color(t_map *map)
{
	...
	result = assign_rgb_values(hold_color_value, &map->c_red, &map->c_green, &map->c_blue);
...
static int  assign_the_floor_color(t_map *map)
{
	...
	result = assign_rgb_values(hold_color_value, &map->f_red, &map->f_green, &map->f_blue);
	ft_free_split(hold_color_value);
	return (result);
}
